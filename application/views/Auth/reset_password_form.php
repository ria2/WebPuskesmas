...
<body class="bg-gradient-green-sea">
                    ...
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            <div class="col-lg-6 d-none d-lg-block">
                                <img src="<?=base_url('asset/img/logodefault.png')?>" class="img-fluid" style="width: 100%;">
                            </div>
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <br>
                                    ...
                                    <form class="user" method="post" action="<?=site_url('Auth/update_password')?>" onsubmit="return validatePassword()">
    ...
    <script>
        function validatePassword() {
            ...
            if (!/\d/.test(password) || !/\d/.test(confirm_password)) {
                Swal.fire({
            ...
            if (!/[a-zA-Z]/.test(password) || !/[a-zA-Z]/.test(confirm_password)) {
                Swal.fire({
