                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="box-header d-flex justify-content-between">
                            ...
                            <a href="<?php echo site_url('Padalarang/Padalarang_admin/TambahBerita'); ?>" class="btn btn-success mb-3">Tambah Berita</a>
                        </div>
                                    ...
                                    <table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        <?php
                                            foreach ($berita->result() as $row) {
                                                $edit = '<a class="btn btn-success  btn-sm" href="' . site_url("Padalarang/Padalarang_admin/UpdateBerita/" . $row->id_berita) . '"><i class="fas fa-edit"></i></a>';
                                                ...
                                                echo '                <a href="' . site_url("Padalarang/Padalarang_admin/deleteBerita/" . $row->id_berita) . '" class="btn btn-danger">Ya</a>';
