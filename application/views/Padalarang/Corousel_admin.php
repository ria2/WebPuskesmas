                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="box-header d-flex justify-content-between">
                            ...
                            <a href="<?php echo site_url('Padalarang/Padalarang_admin/TambahCorousel'); ?>" class="btn btn-success mb-3">Tambah Slide Show</a>
                        </div>
                            ...
                            <div class="box-body">
                                ...
                                <?php echo $this->session->userdata("success"); ?>
                                    <table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                        <?php
                                            foreach ($Padalarang_corousel->result() as $row) {
                                                $edit = '<a class="btn btn-success  btn-sm" href="' . site_url("Padalarang/Padalarang_admin/UpdateCorousel/" . $row->id_corousel) . '"><i class="fas fa-edit"></i></a>';
                                                ...
                                                echo "</tr>";
                                                 ...
                                                 echo '                <a href="' . site_url("Padalarang/Padalarang_admin/deleteCorousel/" . $row->id_corousel) . '" class="btn btn-danger">Ya</a>';
