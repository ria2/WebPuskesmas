                            ...
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    <div class="text-xs font-weight-bold text-danger text-uppercase mb-1">
                                        Total Admin</div>
                                    <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $Padalarang_login; ?></div>
                                </div>
                                <div class="col-auto">
            ...
            function tampilkanPopupGantiKataSandi() {
                ...
                linkGantiKataSandi.addEventListener('click', function (event) {
                    ...
                    const url = "<?= site_url('Padalarang/Padalarang_admin/updateAdmin/' . $this->session->userdata('id_login')) ?>";
