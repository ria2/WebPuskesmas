                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="p-5">
                                                ...
                                                <form class="user" method="post" action="<?=site_url('Padalarang/Auth/prosesLogin')?>" enctype="multipart/form-data">
                                                ...
                                                <hr>
                                                <div class="text-center">
                                                    <a class="small" href="<?=site_url('Padalarang/Auth/Lupapw')?>">Lupa Password?</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
