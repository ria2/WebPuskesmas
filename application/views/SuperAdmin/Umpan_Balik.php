                        ...
                        <table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0">
                            ...
                            <?php
                                foreach ($umpan_balik->result() as $row) {
                                    ...
                                    $balas = '<a class="btn btn-warning btn-sm " href="' . site_url("SuperAdmin/Content/BalasPengaduan/" . $row->id_umpan_balik) . '"><i class="fas fa-share"></i></a>';
                                    echo "<tr>";
                                    echo "<td>" . $row->nama . "</td>";
                                    ...
                                    echo "<td class='text-center'>" . $balas . "</td>";
                                    echo "</tr>";
